...
do
	python parameterized_sample.py --generator hs_brexit_distr_gen --n_items=${n_items} --k_responses=${k_responses} --num_samples=1000 --distortion=${d} --exp_dir=
...
python gather_table.py --n_items=${n_items} --k_responses=${k_responses} --distortion=0.1,0.2,0.3,0.37,0.4